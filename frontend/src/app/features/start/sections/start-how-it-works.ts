...
@Component({
  selector: 'app-start-how-it-works',
  template: `
    <section class="py-16 md:py-20" aria-labelledby="how-title">
...
export class StartHowItWorks {
  protected readonly steps = [
    {
      title: 'Instale o plugin no Claude Cowork',
      description:
        'Adicione o marketplace do GitHub e instale o plugin Especialista em Contabilidade no Claude Cowork.',
    },
    {
      title: 'Conte sobre seu negócio',
      description:
        'Explique o contexto uma vez só. O Especialista lembra do seu ramo, regime e rotina.',
    },
    {
      title: 'Receba perguntas inteligentes',
      description:
        'Tire dúvidas em linguagem simples e receba resumos prontos para enviar ao seu contador.',
    },
  ];
}
