    ...
    <section class="relative overflow-hidden" aria-labelledby="hero-title">
      ...
      >
        <div>
          ...
          <h1
            id="hero-title"
            class="text-headline-lg-mobile md:text-display-lg mt-6 text-on-surface"
          >
          ...
          <div class="mt-8 flex flex-wrap items-center gap-4">
            <a
              ...
              class="btn-primary"
              >Comece a utilizar agora</a
            >
            <a routerLink="/" class="btn-secondary">Voltar para a página inicial</a>
          </div>
