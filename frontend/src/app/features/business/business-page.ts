...
@Component({
  ...
  template: `
    <main class="flex min-h-dvh items-center justify-center px-4 py-16">
      ...
      >
        <h1 class="text-headline-md text-on-surface">Para Empresas</h1>
        <p class="text-body-md mt-4 text-on-surface-variant">
          Em breve, explicaremos como o Especialista em Contabilidade atende empresas de
          diferentes portes. Estamos preparando tudo para que sua experiência seja simples e
          intuitiva.
        </p>
